        ...
        <div className="bg-white w-64 h-96 flex flex-col gap-6 justify-center items-center rounded-lg shadow-lg border mb-8">
            ...
            <div className="flex flex-col items-center ">
                <div className="py-3 font-poppins">
                    ...
                    <p className="text-gray-700 text-center font-semibold"> ${price}</p>
                </div>
                <button className="flex justify-center items-center px-6 py-3 border-0 rounded-xl bg-slate-800 shadow-sm tracking-wider text-base font-medium text-white transition-all duration-300 hover:letter-spacing-3 hover:bg-indigo-400 hover:text-blue-950 hover:shadow-lg active:letter-spacing-3 active:bg-indigo-600 active:text-white active:shadow-none active:translate-y-5 active:transition-100 font-inter" onClick={() => addToCart(id)}> 
