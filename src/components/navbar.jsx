    ...
    return (
        <div className="sticky top-0 bg-slate-800 flex justify-center w-full py-7 z-10">
            <div className="text-cyan-50 flex justify-between w-11/12">
                <Link className="text-xl flex justify-center items-center gap-4 font-rowdies hover:text-gray-300" to="/"> <img className="w-12" src="/bridge4.png" alt="" /> Cosmere Collection </Link>
