    ...
    return (
        <form className="sm:block lg:w-1/3 z-0" onSubmit={handleSubmit}>   
            ...
            <div className="relative">
                ...
                <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-slate-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium font-inter rounded-lg text-sm px-4 py-2 ">Search</button>
            </div>
        </form>
    )
}
